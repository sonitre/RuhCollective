...
var ReactDev, Object_create, Object_freeze, require, React;
...
// React contains this code, but it doesn't run it soon enough to be helpful.                                          // 1
                                                                                                                       // 2
var expectedFeatures = [                                                                                               // 3
  Array.isArray,                                                                                                       // 4
  Array.prototype.every,                                                                                               // 5
  Array.prototype.forEach,                                                                                             // 6
  ...
  String.prototype.trim                                                                                                // 13
];                                                                                                                     // 14
                                                                                                                       // 15
for (var i = 0; i < expectedFeatures.length; i++) {                                                                    // 16
  if (!expectedFeatures[i]) {                                                                                          // 17
    console.error(                                                                                                     // 18
      'One or more ES5 shims expected by React are not available: ' +                                                  // 19
        'Add the es5-shim package with `meteor add es5-shim`'                                                          // 20
    );                                                                                                                 // 21
    break;                                                                                                             // 22
  }                                                                                                                    // 23
}                                                                                                                      // 24
